...
PATCH_BRANCHES=("patch-linux-audio-v2" "feature-disable-update-service-v2" "feature-win-installer-v2" "feature-cicd-v2" "feature-linux-pkgbuild-v2" "patch-readme-v2")
