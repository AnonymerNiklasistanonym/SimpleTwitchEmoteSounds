...
git fetch upstream
git switch -C master-test
git reset --hard upstream/master

PATCH_BRANCHES=("patch-windows-installer-nsis" "patch-multistage-cicd" "patch-multistage-cicd-linux" "patch-multistage-cicd-windows-installer-nsis" "patch-multistage-cicd-release-notes" "patch-linux-audio" "patch-linux-pkgbuild" "patch-config-numbers" "patch-readme" "patch-avalonia-tab-navigation")
