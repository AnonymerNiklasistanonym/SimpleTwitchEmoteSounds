...
cd SimpleTwitchEmoteSounds
dotnet publish SimpleTwitchEmoteSounds/SimpleTwitchEmoteSounds.csproj -o publish -r win-x64 -c Release -p:PublishSingleFile=true -p:DebugType=none -p:PublishReadyToRun=false -p:IncludeNativeLibrariesForSelfExtract=true --self-contained false
