...
>
> ```sh
> dotnet publish --project SimpleTwitchEmoteSounds/SimpleTwitchEmoteSounds.csproj -o publish -c Release -p:PublishSingleFile=true -p:DebugType=none -p:PublishReadyToRun=false -p:IncludeNativeLibrariesForSelfExtract=true --self-contained false -p:DefineConstants="DISABLE_UPDATE_SERVICE"
> ```
>
